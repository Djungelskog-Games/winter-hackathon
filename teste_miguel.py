...
class World:
    def __init__(self, x, y, tilepack, tilesize, display, scale, player1_class, player2_class):
        ...
        self.player1 = Player(self.player_images.get(player1_class, "assets/Classes/lebre_icon.png"), pos1, speed=0.5, scale= self.scale, class_name=player1_class)
        self.player2 = Player(self.player_images.get(player2_class, "assets/Classes/lebre_icon.png"), pos2, speed=0.5, scale= self.scale, class_name=player2_class)
        self.current_turn = "Jogador1"
    ...
    def draw_map(self):
        ...
        while running:
            ...
            if self.current_turn == "Jogador1" and not self.player1.moving:
                if self.player1.moves_remaining == 0:
                    self.current_turn = "Jogador2"
                    self.player2.moves_remaining = self.player2.move_range
            elif self.current_turn == "Jogador2" and not self.player2.moving:
            ...
            turn_text = font.render(f"Turno: {self.current_turn}", True, BRANCO)
