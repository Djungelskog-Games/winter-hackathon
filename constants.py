...
POWERUPS = [
    ...
    {'type': 'lifesteal', 'name': 'Bruxaria Lunar', 'description': '+20% do dano causado em vida', 'value': 0.2, 'image': 'assets/Powerups/Vampire.png'}
]
...
SOUNDS = {'vencer': pygame.mixer.Sound('assets/Sounds/vencer.wav'),
           ...
           'Salamandra': pygame.mixer.Sound('assets/Sounds/salamandra_ataque.wav'),
